function main() {
  ...
  // setup GLSL program
  const vertexShader = createShader(gl, gl.VERTEX_SHADER, include('positions.vert'));
  const fragmentShader = createShader(gl, gl.FRAGMENT_SHADER, include('text.frag'));
  ...
  var textureInfos = [
    loadImageAndCreateTextureInfo('assets/walking_man.png'),
  ];
